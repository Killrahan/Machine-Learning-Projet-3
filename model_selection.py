"""
This file is used to generate the scores presented in the report with GridSearchCV
It uses fourier transfrom and statistics, without scaling
The simple imputer is used to fill the data

This file was used as a base for the jupyter notebook
"""
...
if __name__ == "__main__":
    ...
    grid = GridSearchCV(estimator=KNeighborsClassifier(),
                        param_grid=params_grid, cv=subject_splitter, n_jobs=-1)
    ...
    clf = RandomForestClassifier(n_estimators=1500, n_jobs=-1,
                                 max_depth=best_param['max_depth'], max_features=best_param['max_features'])
    clf.fit(X_train, y_train)
